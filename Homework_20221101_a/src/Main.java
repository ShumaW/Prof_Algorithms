public class Main {
    public static void main(String[] args) {
        ...
        // отработает 0 итераций (метод отработает 1 итерацию при условии если
        // разница между a и b будет единица);
        // Худший случай - в случае когда одно из чисел будет
        // отрицательным или будет равно 0, метод будет работать бесконечно.
        ...
        // Ответ на доп.2:
        // Лучший случай - если n будет равно от минус бесконечности до 1, метод отработает 0 итераций
        ...
        // Ответ на доп.3
        // Лучший случай - если n будет равно от минус бесконечности до 1, метод отработает 0 итераций. При n=1 метод отработает один раз.
